<h1 align="center">Remotely Inc. Clone</h1>
...
![cover](https://i.ibb.co/16SWfbg/Remotely Inc.-Gif.gif)
...
## Glimpses of Remotely Inc.-clone 😉 :
...
The project repository can be found in [GitHub link](https://github.com/zuhedshaikh95/Remotely Inc.-clone) or just clone the project using this command.

```
Using HTTPS

# git clone https://github.com/zuhedshaikh95/Remotely Inc.-clone.git
```

- Open terminal on your workspace with

```
cd /home/workspace/Remotely Inc.-clone
```
