...
app.use(compression());
app.use(cors({
    origin: ['http://127.0.0.1:3000', 'http://localhost:3000', 'http://localhost:3000', 'https://api.remotelyinc.com/', 'https://remotelyinc.com/', 'https://www.remotelyinc.com/', 'https://www.remotelyinc.com'],
    credentials: true
}));
